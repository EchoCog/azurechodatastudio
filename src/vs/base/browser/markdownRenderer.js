...
const formattedTextRenderer_1 = require("vs/base/browser/formattedTextRenderer");
...
const iconLabels_2 = require("vs/base/common/iconLabels");
const idGenerator_1 = require("vs/base/common/idGenerator");
const lazy_1 = require("vs/base/common/lazy");
const lifecycle_1 = require("vs/base/common/lifecycle");
const marked_1 = require("vs/base/common/marked/marked");
const marshalling_1 = require("vs/base/common/marshalling");
