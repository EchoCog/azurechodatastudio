...
exports.DragAndDropObserver = exports.ModifierKeyEmitter = exports.basicMarkupHtmlTags = exports.DetectedFullscreenMode = exports.Namespace = exports.EventHelper = exports.EventType = exports.Dimension = exports.scheduleAtNextAnimationFrame = exports.runAtThisOrScheduleAtNextAnimationFrame = exports.addStandardDisposableGenericMouseUpListener = exports.addStandardDisposableGenericMouseDownListener = exports.addStandardDisposableListener = void 0;
...
const dompurify = __importStar(require("vs/base/browser/dompurify/dompurify"));
...
const defaultSafeProtocols = [
	...
	network_1.Schemas.vscodeFileResource // {{SQL CARBON EDIT}} Add allowed schema for welcome page support
];
/**
...
/**
	...
	*/
function safeInnerHtml(node, value, allowUnknownProtocols = false) {
...
class ModifierKeyEmitter extends event.Emitter {
	_subscriptions = new lifecycle_1.DisposableStore();
	_keyStatus;
	static instance;
	constructor() {
		super();
