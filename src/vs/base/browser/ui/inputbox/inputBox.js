...
const aria = __importStar(require("vs/base/browser/ui/aria/aria"));
...
const history_1 = require("vs/base/common/history");
...
class InputBox extends widget_1.Widget {
	...
	_onDidHeightChange = this._register(new event_2.Emitter());
...
class HistoryInputBox extends InputBox {
	history;
	observer;
	_onDidFocus = this._register(new event_2.Emitter());
	onDidFocus = this._onDidFocus.event;
	_onDidBlur = this._register(new event_2.Emitter());
