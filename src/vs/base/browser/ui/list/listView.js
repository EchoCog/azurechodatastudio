...
exports.ListView = exports.NativeDragAndDropData = exports.ExternalElementsDragAndDropData = exports.ElementsDragAndDropData = exports.StaticDND = void 0;
...
const range_1 = require("vs/base/common/range");
const scrollable_1 = require("vs/base/common/scrollable");
const rangeMap_1 = require("vs/base/browser/ui/list/rangeMap");
const rowCache_1 = require("vs/base/browser/ui/list/rowCache");
...
class ListView {
	...
	scrollableElementWidthDelayer = new async_1.Delayer(50);
	splicing = false;
	dragOverAnimationDisposable;
	dragOverAnimationStopDisposable = lifecycle_1.Disposable.None;
	dragOverMouseY = 0;
	setRowLineHeight;
	setRowHeight;
	...
	currentDragData;
	currentDragFeedback;
	currentDragFeedbackDisposable = lifecycle_1.Disposable.None;
	onDragLeaveTimeout = lifecycle_1.Disposable.None;
	disposables = new lifecycle_1.DisposableStore();
	_onDidChangeContentHeight = new event_2.Emitter();
	_onDidChangeContentWidth = new event_2.Emitter();
	onDidChangeContentHeight = event_2.Event.latch(this._onDidChangeContentHeight.event, undefined, this.disposables);
	onDidChangeContentWidth = event_2.Event.latch(this._onDidChangeContentWidth.event, undefined, this.disposables);
	...
	onDragStart(element, uri, event) {
		...
		exports.StaticDND.CurrentDragAndDropData = new ExternalElementsDragAndDropData(elements);
		this.dnd.onDragStart?.(this.currentDragData, event);
	}
	onDragOver(event) {
		event.browserEvent.preventDefault(); // needed so that the drop event fires (https://stackoverflow.com/questions/21339924/drop-event-not-firing-in-chrome)
		this.onDragLeaveTimeout.dispose();
		if (exports.StaticDND.CurrentDragAndDropData && exports.StaticDND.CurrentDragAndDropData.getData() === 'vscode-ui') {
			return false;
		}
		...
		if (!this.currentDragData) {
			if (exports.StaticDND.CurrentDragAndDropData) {
				// Drag over from another list
				this.currentDragData = exports.StaticDND.CurrentDragAndDropData;
			}
			else {
	...
	onDrop(event) {
		...
		exports.StaticDND.CurrentDragAndDropData = undefined;
