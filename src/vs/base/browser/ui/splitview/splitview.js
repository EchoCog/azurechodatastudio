...
const sash_1 = require("vs/base/browser/ui/sash/sash");
...
class SplitView extends lifecycle_1.Disposable {
	...
	viewItems = [];
	sashItems = []; // used in tests
	sashDragState;
	state = State.Idle;
	inverseAltBehavior;
	proportionalLayout;
	getSashOrthogonalSize;
	_onDidSashChange = this._register(new event_2.Emitter());
	_onDidSashReset = this._register(new event_2.Emitter());
