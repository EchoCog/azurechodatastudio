...
exports.GridView = exports.Sizing = void 0;
exports.orthogonal = orthogonal;
exports.isGridBranchNode = isGridBranchNode;
const dom_1 = require("vs/base/browser/dom");
const splitview_1 = require("vs/base/browser/ui/splitview/splitview");
...
class BranchNode {
	...
	_onDidScroll = new event_1.Emitter();
	onDidScrollDisposable = lifecycle_1.Disposable.None;
	onDidScroll = this._onDidScroll.event;
	childrenChangeDisposable = lifecycle_1.Disposable.None;
	_onDidSashReset = new event_1.Emitter();
	onDidSashReset = this._onDidSashReset.event;
	splitviewSashResetDisposable = lifecycle_1.Disposable.None;
	childrenSashResetDisposable = lifecycle_1.Disposable.None;
	_boundarySashes = {};
...
class LeafNode {
	...
	onDidScroll = event_1.Event.None;
	onDidSashReset = event_1.Event.None;
	_onDidLinkedWidthNodeChange = new event_1.Relay();
	...
	_onDidLinkedHeightNodeChange = new event_1.Relay();
	...
	_onDidSetLinkedNode = new event_1.Emitter();
	_onDidViewChange;
	onDidChange;
...
class GridView {
	...
	proportionalLayout;
	_root;
	onDidSashResetRelay = new event_1.Relay();
	_onDidScroll = new event_1.Relay();
	_onDidChange = new event_1.Relay();
	_boundarySashes = {};
	/**
	 ...
	 */
	layoutController;
	disposable2x2 = lifecycle_1.Disposable.None;
