...
const symbols_1 = require("vs/base/common/symbols");
const diff_1 = require("vs/base/common/diff/diff");
...
class IndexTreeModel {
    ...
    rootRef = [];
    root;
    eventBufferer = new event_1.EventBufferer();
    _onDidChangeCollapseState = new event_1.Emitter();
    onDidChangeCollapseState = this.eventBufferer.wrapEvent(this._onDidChangeCollapseState.event);
    _onDidChangeRenderNodeCount = new event_1.Emitter();
    ...
    refilterDelayer = new async_1.Delayer(symbols_1.MicrotaskDelay);
