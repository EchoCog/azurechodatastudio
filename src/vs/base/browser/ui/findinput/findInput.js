...
const findInputToggles_1 = require("vs/base/browser/ui/findinput/findInputToggles");
...
class FindInput extends widget_1.Widget {
    ...
    additionalTogglesDisposables = new lifecycle_1.DisposableStore();
    controls;
    regex;
    wholeWords;
    caseSensitive;
    ...
    _onCaseSensitiveKeyDown = this._register(new event_1.Emitter());
    onCaseSensitiveKeyDown = this._onCaseSensitiveKeyDown.event;
    _onRegexKeyDown = this._register(new event_1.Emitter());
    ...
    setAdditionalToggles(toggles) {
        ...
        this.additionalTogglesDisposables = new lifecycle_1.DisposableStore();
