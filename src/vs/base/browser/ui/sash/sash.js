...
class Sash extends lifecycle_1.Disposable {
	el;
	layoutProvider;
	hidden; // {{SQL CARBON EDIT}} - ad hidden back
	orientation;
	size;
	hoverDelay = globalHoverDelay;
	hoverDelayer = this._register(new async_1.Delayer(this.hoverDelay));
	_state = 3 /* SashState.Enabled */;
	onDidEnablementChange = this._register(new event_2.Emitter());
	_onDidStart = this._register(new event_2.Emitter());
	_onDidChange = this._register(new event_2.Emitter());
	_onDidReset = this._register(new event_2.Emitter());
	_onDidEnd = this._register(new event_2.Emitter());
	orthogonalStartSashDisposables = this._register(new lifecycle_1.DisposableStore());
	_orthogonalStartSash;
	orthogonalStartDragHandleDisposables = this._register(new lifecycle_1.DisposableStore());
	_orthogonalStartDragHandle;
	orthogonalEndSashDisposables = this._register(new lifecycle_1.DisposableStore());
	_orthogonalEndSash;
	orthogonalEndDragHandleDisposables = this._register(new lifecycle_1.DisposableStore());
