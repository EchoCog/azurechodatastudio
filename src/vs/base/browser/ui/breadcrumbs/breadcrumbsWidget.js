...
class BreadcrumbsWidget {
	_disposables = new lifecycle_1.DisposableStore();
	_domNode;
	_scrollable;
	_onDidSelectItem = new event_1.Emitter();
	_onDidFocusItem = new event_1.Emitter();
	_onDidChangeFocus = new event_1.Emitter();
