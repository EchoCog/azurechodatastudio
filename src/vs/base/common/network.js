...
(function (Schemas) {
    ...
    Schemas.data = 'data';
    Schemas.attachment = 'attachment'; // {{SQL CARBON EDIT}} "Scheme" used for Notebook cell attachment data (not really a scheme but formatted like one...)
...
class RemoteAuthoritiesImpl {
    _defaultWebPort = 80; // {{SQL CARBON EDIT}}
