...
const cache_1 = require("vs/base/common/cache");
...
class AmbiguousCharacters {
    ...
    static ambiguousCharacterData = new lazy_1.Lazy(() => {
    ...
    static cache = new cache_1.LRUCachedFunction((locales) => {
    ...
    static _locales = new lazy_1.Lazy(() => Object.keys(AmbiguousCharacters.ambiguousCharacterData.value).filter((k) => !k.startsWith('_')));
    static getLocales() {
