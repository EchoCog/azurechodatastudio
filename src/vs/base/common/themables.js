...
(function (ThemeIcon) {
	...
	function asClassNameArray(icon) {
		...
		let sqlCarbonIcons = ["active-connections-action" /* SqlIconId.activeConnectionsAction */, "add-server-action" /* SqlIconId.addServerAction */, "add-server-group-action" /* SqlIconId.addServerGroupAction */, "server-page" /* SqlIconId.serverPage */];
