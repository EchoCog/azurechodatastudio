...
const bracketPairsTree_1 = require("vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/bracketPairsTree");
class BracketPairsTextModelPart extends lifecycle_1.Disposable {
    textModel;
    languageConfigurationService;
    bracketPairsTree = this._register(new lifecycle_1.MutableDisposable());
    onDidChangeEmitter = new event_1.Emitter();
