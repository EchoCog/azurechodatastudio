...
const textModelBracketPairs_1 = require("vs/editor/common/textModelBracketPairs");
...
const combineTextEditInfos_1 = require("vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/combineTextEditInfos");
class BracketPairsTree extends lifecycle_1.Disposable {
    textModel;
    getLanguageConfiguration;
    didChangeEmitter = new event_1.Emitter();
    /*
        There are two trees:
    ...
    */
    ...
    astWithTokens;
    denseKeyProvider = new smallImmutableSet_1.DenseKeyProvider();
    brackets = new brackets_1.LanguageAgnosticBracketTokens(this.denseKeyProvider, this.getLanguageConfiguration);
