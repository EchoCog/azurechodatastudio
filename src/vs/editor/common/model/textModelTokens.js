...
const offsetRange_1 = require("vs/editor/common/core/offsetRange");
const nullTokenize_1 = require("vs/editor/common/languages/nullTokenize");
const fixedArray_1 = require("vs/editor/common/model/fixedArray");
const contiguousMultilineTokensBuilder_1 = require("vs/editor/common/tokens/contiguousMultilineTokensBuilder");
const lineTokens_1 = require("vs/editor/common/tokens/lineTokens");
...
class TokenizationStateStore {
	_lineEndStates = new fixedArray_1.FixedArray(null);
	getEndState(lineNumber) {
