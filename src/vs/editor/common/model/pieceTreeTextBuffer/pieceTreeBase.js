...
const model_1 = require("vs/editor/common/model");
const rbTreeBase_1 = require("vs/editor/common/model/pieceTreeTextBuffer/rbTreeBase");
...
class PieceTreeBase {
    root;
    _buffers; // 0 is change buffer, others are readonly original buffer.
    _lineCnt;
    _length;
    _EOL;
    _EOLLength;
