...
exports.AttachedViews = exports.DidChangeDecorationsEmitter = exports.ModelDecorationOptions = exports.ModelDecorationInjectedTextOptions = exports.ModelDecorationMinimapOptions = exports.ModelDecorationGlyphMarginOptions = exports.ModelDecorationOverviewRulerOptions = exports.TextModel = void 0;
...
const stream_1 = require("vs/base/common/stream");
const strings = __importStar(require("vs/base/common/strings"));
const uri_1 = require("vs/base/common/uri");
const eolCounter_1 = require("vs/editor/common/core/eolCounter");
const indentation_1 = require("vs/editor/common/core/indentation");
const lineRange_1 = require("vs/editor/common/core/lineRange");
const position_1 = require("vs/editor/common/core/position");
const range_1 = require("vs/editor/common/core/range");
const selection_1 = require("vs/editor/common/core/selection");
const textModelDefaults_1 = require("vs/editor/common/core/textModelDefaults");
const language_1 = require("vs/editor/common/languages/language");
const languageConfigurationRegistry_1 = require("vs/editor/common/languages/languageConfigurationRegistry");
const model = __importStar(require("vs/editor/common/model"));
const bracketPairsImpl_1 = require("vs/editor/common/model/bracketPairsTextModelPart/bracketPairsImpl");
const colorizedBracketPairsDecorationProvider_1 = require("vs/editor/common/model/bracketPairsTextModelPart/colorizedBracketPairsDecorationProvider");
const editStack_1 = require("vs/editor/common/model/editStack");
const guidesTextModelPart_1 = require("vs/editor/common/model/guidesTextModelPart");
const indentationGuesser_1 = require("vs/editor/common/model/indentationGuesser");
const intervalTree_1 = require("vs/editor/common/model/intervalTree");
const pieceTreeTextBuffer_1 = require("vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer");
const pieceTreeTextBufferBuilder_1 = require("vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder");
const textModelSearch_1 = require("vs/editor/common/model/textModelSearch");
const tokenizationTextModelPart_1 = require("vs/editor/common/model/tokenizationTextModelPart");
const textModelEvents_1 = require("vs/editor/common/textModelEvents");
const undoRedo_1 = require("vs/platform/undoRedo/common/undoRedo");
...
let TextModel = class TextModel extends lifecycle_1.Disposable {
	...
	static LARGE_FILE_SIZE_THRESHOLD = 20 * 1024 * 1024; // 20 MB;
	static LARGE_FILE_LINE_COUNT_THRESHOLD = 300 * 1000; // 300K lines
	...
	_onDidChangeOptions = this._register(new event_1.Emitter());
	onDidChangeOptions = this._onDidChangeOptions.event;
	_onDidChangeAttached = this._register(new event_1.Emitter());
	onDidChangeAttached = this._onDidChangeAttached.event;
	_onDidChangeInjectedText = this._register(new event_1.Emitter());
	...
	_bufferDisposable;
	_options;
	_languageSelectionListener = this._register(new lifecycle_1.MutableDisposable());
	_isDisposed;
	__isDisposing;
...
class DidChangeDecorationsEmitter extends lifecycle_1.Disposable {
	handleBeforeFire;
	_actual = this._register(new event_1.Emitter());
...
class DidChangeContentEmitter extends lifecycle_1.Disposable {
	/**
		...
		*/
	_fastEmitter = this._register(new event_1.Emitter());
	fastEvent = this._fastEmitter.event;
	_slowEmitter = this._register(new event_1.Emitter());
...
/**
	...
	*/
class AttachedViews {
	_onDidChangeVisibleRanges = new event_1.Emitter();
