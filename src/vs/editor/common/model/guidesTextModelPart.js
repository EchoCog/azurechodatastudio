...
const cursorColumns_1 = require("vs/editor/common/core/cursorColumns");
const range_1 = require("vs/editor/common/core/range");
const textModelPart_1 = require("vs/editor/common/model/textModelPart");
const utils_1 = require("vs/editor/common/model/utils");
const textModelGuides_1 = require("vs/editor/common/textModelGuides");
...
class GuidesTextModelPart extends textModelPart_1.TextModelPart {
    ...
    getLinesBracketGuides(startLineNumber, endLineNumber, activePosition, options) {
        ...
        if (activePosition && bracketPairs.length > 0) {
            ...
            activeBracketPairRange = (0, arrays_1.findLast)(bracketsContainingActivePosition, (i) => includeSingleLinePairs || i.range.startLineNumber !== i.range.endLineNumber)?.range;
        }
