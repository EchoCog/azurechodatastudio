...
exports.EditorOptions = exports.editorOptionsRegistry = exports.EDITOR_FONT_DEFAULTS = exports.unicodeHighlightConfigKeys = exports.inUntrustedWorkspace = exports.EditorLayoutInfoComputer = exports.EditorFontVariations = exports.EditorFontLigatures = exports.TextEditorCursorStyle = exports.ApplyUpdateResult = exports.ComputeOptionsMemory = exports.ConfigurationChangedEvent = exports.MINIMAP_GUTTER_WIDTH = void 0;
...
class EditorFontSize extends SimpleEditorOption {
	constructor() {
		super(51 /* EditorOption.fontSize */, 'fontSize', exports.EDITOR_FONT_DEFAULTS.fontSize, {
			type: 'number',
			minimum: 6,
			maximum: 100,
...
class EditorFontWeight extends BaseEditorOption {
	...
	static MAXIMUM_VALUE = 1000;
	constructor() {
		super(52 /* EditorOption.fontWeight */, 'fontWeight', exports.EDITOR_FONT_DEFAULTS.fontWeight, {
			anyOf: [
				{
					type: 'number',
...
class EditorLineHeight extends EditorFloatOption {
	constructor() {
		super(65 /* EditorOption.lineHeight */, 'lineHeight', exports.EDITOR_FONT_DEFAULTS.lineHeight, x => EditorFloatOption.clamp(x, 0, 150), { markdownDescription: nls.localize('lineHeight', "Controls the line height. \n - Use 0 to automatically compute the line height from the font size.\n - Values between 0 and 8 will be used as a multiplier with the font size.\n - Values greater than or equal to 8 will be used as effective values.") });
	}
	compute(env, options, value) {
...
exports.EditorOptions = {
	...
	fontFamily: register(new EditorStringOption(48 /* EditorOption.fontFamily */, 'fontFamily', exports.EDITOR_FONT_DEFAULTS.fontFamily, { description: nls.localize('fontFamily', "Controls the font family.") })),
	...
	letterSpacing: register(new EditorFloatOption(62 /* EditorOption.letterSpacing */, 'letterSpacing', exports.EDITOR_FONT_DEFAULTS.letterSpacing, x => EditorFloatOption.clamp(x, -5, 20), { description: nls.localize('letterSpacing', "Controls the letter spacing in pixels.") })),
	...
	wordSeparators: register(new EditorStringOption(128 /* EditorOption.wordSeparators */, 'wordSeparators', wordHelper_1.USUAL_WORD_SEPARATORS, { description: nls.localize('wordSeparators', "Characters that will be used as word separators when doing word related navigations or operations.") })),
