...
const supports_1 = require("vs/editor/common/languages/supports");
const characterPair_1 = require("vs/editor/common/languages/supports/characterPair");
const electricCharacter_1 = require("vs/editor/common/languages/supports/electricCharacter");
const indentRules_1 = require("vs/editor/common/languages/supports/indentRules");
const onEnter_1 = require("vs/editor/common/languages/supports/onEnter");
const richEditBrackets_1 = require("vs/editor/common/languages/supports/richEditBrackets");
...
const languageBracketsConfiguration_1 = require("vs/editor/common/languages/supports/languageBracketsConfiguration");
...
let LanguageConfigurationService = class LanguageConfigurationService extends lifecycle_1.Disposable {
    ...
    onDidChangeEmitter = this._register(new event_1.Emitter());
