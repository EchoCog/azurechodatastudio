...
const editorInput_1 = require("vs/workbench/common/editor/editorInput");
const sideBySideEditorInput_1 = require("vs/workbench/common/editor/sideBySideEditorInput");
...
let EditorGroupModel = class EditorGroupModel extends lifecycle_1.Disposable {
	...
	static IDS = 0;
	//#region events
	_onDidModelChange = this._register(new event_1.Emitter());
