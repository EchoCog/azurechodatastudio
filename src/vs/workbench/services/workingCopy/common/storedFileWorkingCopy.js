...
exports.StoredFileWorkingCopy = void 0;
...
const workingCopyFileService_1 = require("vs/workbench/services/workingCopy/common/workingCopyFileService");
const filesConfigurationService_1 = require("vs/workbench/services/filesConfiguration/common/filesConfigurationService");
const workingCopyBackup_1 = require("vs/workbench/services/workingCopy/common/workingCopyBackup");
const notification_1 = require("vs/platform/notification/common/notification");
...
const workingCopyEditorService_1 = require("vs/workbench/services/workingCopy/common/workingCopyEditorService");
const editorService_1 = require("vs/workbench/services/editor/common/editorService");
const elevatedFileService_1 = require("vs/workbench/services/files/common/elevatedFileService");
const resourceWorkingCopy_1 = require("vs/workbench/services/workingCopy/common/resourceWorkingCopy");
...
let StoredFileWorkingCopy = class StoredFileWorkingCopy extends resourceWorkingCopy_1.ResourceWorkingCopy {
	...
	_onDidResolve = this._register(new event_1.Emitter());
	onDidResolve = this._onDidResolve.event;
	_onDidChangeDirty = this._register(new event_1.Emitter());
	onDidChangeDirty = this._onDidChangeDirty.event;
	_onDidSaveError = this._register(new event_1.Emitter());
	...
	_onDidChangeReadonly = this._register(new event_1.Emitter());
	...
	saveSequentializer = new async_1.TaskSequentializer();
