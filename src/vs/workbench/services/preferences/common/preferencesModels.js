...
const json_1 = require("vs/base/common/json");
...
const preferences_1 = require("vs/workbench/services/preferences/common/preferences");
const configuration_2 = require("vs/workbench/services/configuration/common/configuration");
const preferencesValidation_1 = require("vs/workbench/services/preferences/common/preferencesValidation");
...
class AbstractSettingsModel extends editorModel_1.EditorModel {
	...
	filterSettings(filter, groupFilter, settingMatcher) {
		...
		filterMatches.sort((a, b) => {
			...
			else if (a.matchType === preferences_1.SettingMatchType.RemoteMatch) {
...
class SettingsEditorModel extends AbstractSettingsModel {
	...
	_settingsGroups;
	settingsModel;
	_onDidChangeGroups = this._register(new event_1.Emitter());
...
class DefaultSettings extends lifecycle_1.Disposable {
	_mostCommonlyUsedSettingsKeys;
	target;
	_allSettingsGroups;
	_content;
	_contentWithoutMostCommonlyUsed;
	_settingsByName = new Map();
...
class DefaultSettingsEditorModel extends AbstractSettingsModel {
	...
	writeSettingsGroupToBuilder(builder, settingsGroup, filterMatches) {
		filterMatches = filterMatches
			...
			return {
				matchType: preferences_1.SettingMatchType.None, // {{SQL CARBON EDIT}} - add missing property
