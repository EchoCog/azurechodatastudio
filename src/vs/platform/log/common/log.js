...
class AbstractLogger extends lifecycle_1.Disposable {
    ...
    _onDidChangeLogLevel = this._register(new event_1.Emitter());
...
class AbstractLoggerService extends lifecycle_1.Disposable {
    logLevel;
    logsHome;
    _loggers = new map_1.ResourceMap();
    _onDidChangeLoggers = this._register(new event_1.Emitter);
...
class NullLogger {
    onDidChangeLogLevel = new event_1.Emitter().event;
    setLevel(level) { }
