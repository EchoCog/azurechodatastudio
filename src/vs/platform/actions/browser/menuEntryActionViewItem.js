...
require("vs/css!./menuEntryActionViewItem");
const nls_1 = require("vs/nls");
const actions_2 = require("vs/platform/actions/common/actions");
const action_1 = require("vs/platform/action/common/action");
...
const storage_1 = require("vs/platform/storage/common/storage");
...
function fillInActions(// {{SQL CARBON EDIT}} add export modifier
groups, target, useAlternativeActions, isPrimaryAction = actionGroup => actionGroup === 'navigation', shouldInlineSubmenu = () => false, useSeparatorsInPrimaryActions = false) {
    let primaryBucket;
    let secondaryBucket;
...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends actionViewItems_1.ActionViewItem {
    ...
    _itemClassDispose = this._register(new lifecycle_1.MutableDisposable());
    _altKey;
