...
const ternarySearchTree_1 = require("vs/base/common/ternarySearchTree");
...
class Workspace {
    ...
    _configuration;
    _ignorePathCasing;
    _foldersMap = ternarySearchTree_1.TernarySearchTree.forUris(this._ignorePathCasing, () => true);
    _folders;
