...
exports.InMemoryStorageService = exports.AbstractStorageService = exports.WillSaveStateReason = exports.IStorageService = exports.TARGET_KEY = exports.IS_NEW_KEY = void 0;
...
const performance_1 = require("vs/base/common/performance");
const types_1 = require("vs/base/common/types");
const storage_1 = require("vs/base/parts/storage/common/storage");
const instantiation_1 = require("vs/platform/instantiation/common/instantiation");
const userDataProfile_1 = require("vs/platform/userDataProfile/common/userDataProfile");
...
class AbstractStorageService extends lifecycle_1.Disposable {
	...
	_onDidChangeValue = this._register(new event_1.PauseableEmitter());
	_onDidChangeTarget = this._register(new event_1.PauseableEmitter());
	onDidChangeTarget = this._onDidChangeTarget.event;
	_onWillSaveState = this._register(new event_1.Emitter());
	onWillSaveState = this._onWillSaveState.event;
	initializationPromise;
	flushWhenIdleScheduler = this._register(new async_1.RunOnceScheduler(() => this.doFlushWhenIdle(), this.options.flushInterval));
	runFlushWhenIdle = this._register(new lifecycle_1.MutableDisposable());
...
class InMemoryStorageService extends AbstractStorageService {
	applicationStorage = this._register(new storage_1.Storage(new storage_1.InMemoryStorageDatabase(), { hint: storage_1.StorageHint.STORAGE_IN_MEMORY }));
	profileStorage = this._register(new storage_1.Storage(new storage_1.InMemoryStorageDatabase(), { hint: storage_1.StorageHint.STORAGE_IN_MEMORY }));
	workspaceStorage = this._register(new storage_1.Storage(new storage_1.InMemoryStorageDatabase(), { hint: storage_1.StorageHint.STORAGE_IN_MEMORY }));
	constructor() {
		super();
