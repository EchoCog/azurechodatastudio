...
exports.contrastBorder = registerColor('contrastBorder', { light: null, dark: null, hcLight: '#6FC3DF', hcDark: '#6FC3DF' }, nls.localize('contrastBorder', "An extra border around elements to separate them from others for greater contrast."));
...
exports.buttonForeground = registerColor('button.foreground', { dark: color_1.Color.white, light: color_1.Color.white, hcLight: color_1.Color.black, hcDark: color_1.Color.white }, nls.localize('buttonForeground', "Button foreground color."));
...
exports.buttonBackground = registerColor('button.background', { dark: '#0E639C', light: '#007ACC', hcLight: null, hcDark: null }, nls.localize('buttonBackground', "Button background color."));
...
exports.buttonBorder = registerColor('button.border', { dark: exports.contrastBorder, light: exports.contrastBorder, hcLight: exports.contrastBorder, hcDark: exports.contrastBorder }, nls.localize('buttonBorder', "Button border color."));
exports.buttonSecondaryForeground = registerColor('button.secondaryForeground', { dark: color_1.Color.white, light: color_1.Color.white, hcLight: color_1.Color.black, hcDark: color_1.Color.white }, nls.localize('buttonSecondaryForeground', "Secondary button foreground color."));
exports.buttonSecondaryBackground = registerColor('button.secondaryBackground', { dark: '#3A3D41', light: '#5F6A79', hcLight: null, hcDark: null }, nls.localize('buttonSecondaryBackground', "Secondary button background color."));
exports.buttonSecondaryHoverBackground = registerColor('button.secondaryHoverBackground', { dark: lighten(exports.buttonSecondaryBackground, 0.2), light: darken(exports.buttonSecondaryBackground, 0.2), hcLight: null, hcDark: null }, nls.localize('buttonSecondaryHoverBackground', "Secondary button background color when hovering."));
// new button colors introduced by ADS
exports.buttonSecondaryBorder = registerColor('button.secondaryBorder', { dark: '#4894FE', light: '#8A8886', hcLight: exports.contrastBorder, hcDark: exports.contrastBorder }, nls.localize('button.secondaryBorder', "Secondary button border color."));
exports.buttonDisabledBorder = registerColor('button.disabledBorder', { dark: new color_1.Color(new color_1.RGBA(127, 127, 127, 0.1)), light: '#F3F2F1', hcLight: exports.disabledForeground, hcDark: '#00FF00' }, nls.localize('button.secondaryBorder', "Secondary button border color."));
exports.buttonDisabledForeground = registerColor('button.disabledForeground', { dark: new color_1.Color(new color_1.RGBA(127, 127, 127, 0.7)), light: '#A19F9D', hcLight: exports.disabledForeground, hcDark: '#00FF00' }, nls.localize('button.disabledForeground', "Disabled button foreground color."));
exports.buttonDisabledBackground = registerColor('button.disabledBackground', { dark: new color_1.Color(new color_1.RGBA(127, 127, 127, 0.1)), light: '#F3F2F1', hcLight: color_1.Color.black, hcDark: color_1.Color.black }, nls.localize('button.disabledBackground', "Disablbed button background color."));
...
exports.diffUnchangedRegionBackground = registerColor('diffEditor.unchangedRegionBackground', { dark: '#3e3e3e', light: '#e4e4e4', hcDark: null, hcLight: null }, nls.localize('diffEditor.unchangedRegionBackground', "The background color of unchanged blocks in the diff editor."));
...
exports.listInactiveSelectionBackground = registerColor('list.inactiveSelectionBackground', { dark: '#37373D', light: '#6971B7', hcDark: null, hcLight: color_1.Color.fromHex('#0F4A85').transparent(0.1) }, nls.localize('listInactiveSelectionBackground', "List/Tree background color for the selected item when the list/tree is inactive. An active list/tree has keyboard focus, an inactive does not."));
