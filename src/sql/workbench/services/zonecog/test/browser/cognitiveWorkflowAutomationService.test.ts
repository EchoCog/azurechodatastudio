...
suite('CognitiveWorkflowAutomationService', () => {
	...
	let aarService: AAROrchestrationService;
	...
	const multiStepWorkflow: CognitiveWorkflowDefinition = {
	...
	const conditionalWorkflow: CognitiveWorkflowDefinition = {
	...
	const invalidWorkflow: Partial<CognitiveWorkflowDefinition> = {
	...
	setup(() => {
		...
		zonecogService = new ZoneCogService(logService, hypergraphStore, membraneService, llmService, ecanService);
	...
	test('should throw for invalid workflow', () => {
		try {
			service.registerWorkflow(invalidWorkflow as CognitiveWorkflowDefinition);
...
`;
	...
	test('should handle workflow execution error gracefully', async () => {
		const failingWorkflow: CognitiveWorkflowDefinition = {
			id: 'failing-workflow',
